...
### Artifacts and Projects  
- Drone Module 2 ERD  
- Rewards Module 2 ERD  
- SQL Query Labs:  
  - Jxiong34_m4.5 QueryLab.sql  
...
## Block 1 Summary  
Through **Intro to Computers & Programming** and **Database 1**, I built the core skills that define my path as a data analyst. I learned how systems store, process, and organize data and how programming logic connects to analytics. These courses taught me to think critically, structure my work clearly, and see how data flows from code to insight.  
